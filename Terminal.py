...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.label_employee = QLabel('Сотрудник:')
    ...
    def add_employee(self):
        ...
        try:
            cursor.execute("INSERT INTO employees (last_name, first_name, pass_number) VALUES (?, ?, ?)", (last_name, first_name, pass_number,))
            conn.commit()
    ...
    def add_guest(self):
        ...
        try:
            cursor.execute("INSERT INTO guests (last_name, first_name, pass_number) VALUES (?, ?, ?)", (last_name, first_name, pass_number))
            conn.commit()
